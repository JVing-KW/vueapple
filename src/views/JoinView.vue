  ...
  >
    ...
    <div class="body">
          ...
          <div class="header-container container-fluid">
            <div class="header-row p-relative px-0">
              ...
              <div class="header-column w-100 ms-2 ms-xl-5 ps-2 pe-lg-3">
                <div
                  class="header-row justify-content-end justify-content-lg-start"
                >
                  <div
                    class="header-nav header-nav-links header-nav-light-text justify-content-lg-start"
                  >
                    <div
                        ...
                        <ul class="nav nav-pills" id="mainNav">
                                      ...
                                      <ul class="dropdown-mega-sub-nav">
                                        ...
                                        <li>
                                          <a
                                            ...
                                            >Animations
                                            <span
                                              class="tip tip-dark p-relative bottom-2"
                                              >hot</span
                                            ></a
                                          >
                                        </li>
                          ...
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                      ...
                                      <li>
                                        <a
                                          ...
                                          >Transparent Light + Bottom Border</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                          ...
                                          >Transparent Dark + Bottom Border</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                      ...
                                      <li>
                                        <a
                                          ...
                                          >Transparent Top Bar Extra Buttons</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                      ...
                                      <li>
                                        <a
                                          ...
                                          >Semi Transparent Bottom Slider</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                    ...
                                    <ul class="dropdown-menu">
                                      ...
                                      <li>
                                        <a
                                          ...
                                          >Full Width Transparent Light</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                      ...
                                      <li>
                                        <a
                                          ...
                                          >Full Width Semi Transparent Light</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                          ...
                                          >Full Width Semi Transparent Dark</a
                                        >
                                      </li>
                                      <li>
                                        <a
                                          ...
                                          >Full Width 2 Rows + Extra Buttons</a
                                        >
                                      </li>
                                    </ul>
                                  </li>
                              ...
                              <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li>
                                    <a
                                      class="dropdown-item"
                                      href="feature-horizontal-scroll.html"
                                      >Horizontal Scroll</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="dropdown-item"
                                      href="feature-locomotive-scroll.html"
                                      >Locomotive Scroll</a
                                    >
                                  </li>
                                  <li>
                              ...
                              <li class="dropdown-submenu">
                                <a class="dropdown-item" href="#"
                                  >Admin Extension<em class="not-included"
                                    >(Not Included)</em
                                  ></a
                                >
                                <ul class="dropdown-menu">
                          ...
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li>
                                <a class="dropdown-item" href="shop-login.html"
                                  >Login</a
                                >
                              </li>
                              <li>
                  ...
                  <div class="d-flex">
                    <div class="d-none d-xxl-flex custom-header-1-extra-links">
                      <ul class="nav me-3 mt-1">
                        <li class="nav-item">
                          <a
                            class="nav-link text-color-light text-2 font-weight-semibold"
                            target="_blank"
                            href="https://www.okler.net/open-a-ticket/"
                            >Support</a
                          >
                        </li>
                        <li class="nav-item">
                          <a
                            class="nav-link text-color-light text-2 font-weight-semibold"
                            target="_blank"
                            href="https://www.okler.net/previews/porto/docs/"
                            >Documentation</a
                          >
                        </li>
                      </ul>
                      ...
                      <a
                        class="btn btn-primary font-weight-semibold text-3 py-3 border-radius p-relative bottom-1 custom-header-1-btn-1"
                        href="https://themeforest.net/checkout/from_item/4106987?license=regular&support=bundle_6month&ref=Okler"
                        target="_blank"
                        ><span class="px-4 d-block ws-nowrap">Buy Now</span></a
                      >
                    </div>
                    <button
      ...
      <div role="main" class="main">
        ...
        >
          <div
            class="section-angled-layer-bottom section-angled-layer-increase-angle bg-light"
          ...
          <div class="container pt-lg-5 mt-5">
            <div class="row pt-3 pb-lg-0 pb-xl-0">
              <div class="col-lg-6 pt-4 mb-5 mb-lg-0">
                <ul
                  class="breadcrumb font-weight-semibold text-4 negative-ls-1"
                >
                ...
                <h1
                  class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3"
                >
                  Forms
                </h1>
                <p class="opacity-7 text-4 negative-ls-05 pb-2 mb-4">
                  From a simple contact form to a more advanced with Google
                  reCaptcha enabled. Easy to configure trough the template
                  files.
                </p>
                <a
                  href="#examples"
                  ...
                  >View Examples <i class="fas fa-arrow-down ms-1"></i
                ></a>
                <a
                  href="https://themeforest.net/checkout/from_item/4106987?license=regular&support=bundle_6month&ref=Okler"
                  class="btn btn-light btn-outline btn-outline-thin btn-outline-light-opacity-2 btn-effect-5 font-weight-semi-bold px-4 btn-py-2 text-3 text-color-light text-color-hover-dark ms-2"
                  target="_blank"
                  >Buy Porto <i class="fas fa-external-link-alt ms-1"></i
                ></a>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-3 order-2 order-lg-1">
              <aside class="sidebar mt-2 mb-5">
                ...
                <ul class="nav nav-list flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsStyleDefault"
                      >Default</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsStyleWithoutBorders"
                      >Without Borders</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsStyleColors"
                      >Colors</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsStyleWithIcons"
                      >With Icons</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsStyleRoundedBorders"
                      >Rounded Borders</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsStyleBottomLine"
                      >Bottom Line</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsStyleWithShadow"
                      >With Shadow</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsStyleSquaredBorders"
                      >Squared Borders</a
                    >
                  </li>
                </ul>
              ...
              <aside class="sidebar mt-2 mb-5">
                ...
                <ul class="nav nav-list flex-column">
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsExamplesFormControl"
                      >Form Control</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsExamplesSelect"
                      >Select</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsExamplesChecksRadios"
                      >Checks & Radios</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsExamplesRange"
                      >Range</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsExamplesInputGroup"
                      >Input Group</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsExamplesFloatingLabels"
                      >Floating Labels</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsExamplesLayout"
                      >Layout</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms.html#formsExamplesValidation"
                      >Validation</a
                    >
                  </li>
                </ul>
              ...
              <aside class="sidebar mt-2">
                ...
                <ul class="nav nav-list flex-column">
                  <li class="nav-item">
                    <a class="nav-link" href="elements-forms-basic-contact.html"
                      >Basic Contact Form</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms-advanced-contact.php"
                      >Advanced Contact Form</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms-contact-recaptcha-v2.html"
                      >Contact Form with Recaptcha v2</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      class="nav-link"
                      href="elements-forms-contact-recaptcha-v3.html"
                      >Contact Form with Recaptcha v3</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="elements-forms-login.html"
                      >Login</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      ...
                      href="elements-forms-signup.html"
                      >Sign Up</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="elements-forms-lost-password.html"
                      >Lost Password</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="elements-forms-user-profile.html"
                      >User Profile</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="elements-forms-checkout.html"
                      >Checkout</a
                    >
                  </li>
                </ul>
            ...
            <div class="col-lg-9 order-1 order-lg-2">
              <div class="row justify-content-md-center">
                <div class="col-md-9">
                  <div
                    class="featured-box featured-box-primary text-start mt-0"
                  >
        ...
        <section
          id="elements"
          class="section section-height-2 border-0 mt-5 mb-0 pt-5"
        >
          <div class="container py-2">
            <div class="row mt-3 pb-4">
              <div class="col text-center">
                ...
                <p class="lead text-4 pt-2 font-weight-normal">
                  Porto comes with several elements options, it's easy to
                  customize<br />
            ...
            <div class="row justify-content-center">
              <div class="col-6 col-sm-4 col-lg-2">
                ...
                >
                  <div
                    class="featured-box featured-box-no-borders featured-box-box-shadow"
                  >
                    <a
                      href="elements-accordions.html"
                    ...
                    >
                      <span class="box-content px-1 py-4 text-center d-block">
                        <span
                          class="text-primary text-8 position-relative top-3 mt-3"
        ...
        <section
          class="section section-dark section-angled border-0 lazyload pb-0 m-0"
          style="background-size: 100%; background-position: top"
          data-bg-src="img/landing/build_bg.jpg"
        >
          <div
          ...
          <div class="container text-center my-5 py-5">
            <h2
              class="font-weight-bold line-height-3 text-12 mt-5 mb-3 appear-animation"
            ...
            <h4
              class="font-weight-bold text-9 mb-4 pb-2 appear-animation"
              data-appear-animation="fadeInUpShorter"
            ...
            >
              <h4
                class="font-weight-light text-4 col-lg-6 px-0 offset-lg-3 fw-400 mb-5 opacity-8"
              >
                Porto Template has been available on ThemeForest since 2013 and
                is one of the top sellers with more than 45K+ sales.
              </h4>
            </div>
            <div class="col-12 px-0 pb-2 mb-4">
              <div class="row flex-column flex-lg-row justify-content-center">
                <div class="col-auto">
                  <h5
                    class="font-weight-semibold text-4 positive-ls-2 appear-animation"
                ...
                <div class="col-auto">
                  <h5
                    ...
                    data-appear-animation-duration="750"
                  >
                    <i class="fa fa-check"></i> Free Lifetime Updates
                  </h5>
                </div>
              </div>
            </div>
          ...
          <div
            class="row border border-start-0 border-bottom-0 border-end-0 border-color-light-2"
          >
            <div
              class="col-6 col-md-3 text-center d-flex align-items-center justify-content-center py-4"
            >
              <a
              ...
              >
                <div class="icon-box">
                  ...
                  <h4 class="text-4 mb-0">
                    Customer Showcase<small
                      class="d-block p-relative bottom-4 opacity-6 ls-0"
                      >(SAMPLE SITES)</small
                    >
                  </h4>
                </div>
            ...
            >
              ...
              >
                <div class="icon-box">
                  ...
                  <h4
                    class="font-weight-500 text-color-light line-height-1 text-4 mt-0 mb-2"
                  >
                    Video Tutorials<br /><span class="text-2 d-block pt-1"
                      >(coming soon)</span
                    >
                  </h4>
                </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col">
                ...
                >
                  <li
                    class="list-inline-item custom-text-color-1 color-inherit mb-lg-0 text-2 pe-2"
                  >
                    Porto Versions:
                  </li>
      ...
      >
        <div class="container text-center my-3 py-5">
          <a href="index.html">
            <img
              src="img/lazy.png"
              data-src="img/landing/logo.png"
              width="102"
              height="45"
              class="mb-4 appear-animation lazyload"
              alt="Porto"
              data-appear-animation="fadeIn"
        ...
        <div class="copyright bg-color-dark-100 py-4">
          <div class="container text-center py-2">
            <p class="mb-0 text-2">
              Copyright 2013 - 2023 - Porto - All Rights Reserved
            </p>
          </div>
        </div>
      </footer>
